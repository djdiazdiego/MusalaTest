...
{
    public sealed class PeripheralDeviceStatusGetQueryHandler : GetQueryHandler<Domain.Models.GatewayAggregate.PeripheralDeviceStatus, EnumerationDto, PeripheralDeviceStatusGetQuery>
    {
