...
{
    public class GatewayFilterQueryTest
    {
        ...
        [Test]
        public async Task FilterGateway()
        {
            ...
            var query = new GatewayFilterQuery
            {
            ...
            var queryHandler = new GatewayFilterQueryHandler(gatewayRepository, mapper);
            ...
            Assert.AreEqual(11, queryResult.Data.Total);
